...
| 004 | Sub-clippy lifecycle and explosion | prototype | ⬜ | 003, 007, 008 | [004-sub-clippy-lifecycle-and-explosion.md](tickets/004-sub-clippy-lifecycle-and-explosion.md) |
...
**Frontier (takeable next):** Floating window with animated avatar · Sandbox by default, build mode on toggle · One-shot demo scenario · Install Pi locally · Demo provider and model

**Blocked:** Sub-clippy lifecycle and explosion (waits on 003, 007, 008)