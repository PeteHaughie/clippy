...
Legend: ✅ closed · ⬜ open but blocked · 👀 open/unblocked/unclaimed (takeable frontier)
...
| 004 | Sub-clippy lifecycle and explosion | prototype | ⬜ | 003, 008 | [004-sub-clippy-lifecycle-and-explosion.md](tickets/004-sub-clippy-lifecycle-and-explosion.md) |
...
\* claimed by wayfinder (in progress)

**Frontier (takeable next):** Sandbox by default, build mode on toggle · One-shot demo scenario · Demo provider and model · *(Floating window with animated avatar — claimed, in progress)*

**Blocked:** Sub-clippy lifecycle and explosion (waits on 003, 008)