...
| 004 | Sub-clippy lifecycle and explosion | prototype | ⬜ | 008 | [004-sub-clippy-lifecycle-and-explosion.md](tickets/004-sub-clippy-lifecycle-and-explosion.md) |
...
**Blocked:** Sub-clippy lifecycle and explosion (waits on 008 — window stack from 003 now done, Pi from 007 installed)