...
| 005 | Sandbox by default, build mode on toggle | grilling | 🅿️ | — | [005-sandbox-by-default-build-mode-on-toggle.md](tickets/005-sandbox-by-default-build-mode-on-toggle.md) |
...
**Frontier (takeable next):** 🅿️ 005 parked · 👀 **011** (interactive pane bridge) unclaimed and unblocked — 012/013 wait on 002 + predecessors.