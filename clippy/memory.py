...
#: memory-store protocol, the sub-clippy delegation protocol, the movement
#: protocol, the scheduling protocol, and the notification protocol.
ALWAYS_ON_SKILLS = ("memory", "move", "sub-clippy", "schedule", "notify")
